...
def scale_to_range(data, left_bound, right_bound):
    return ((data - np.min(data)) / (np.max(data) - np.min(data))) * (right_bound - left_bound) + left_bound
...
# data = [[5], [8], [-1], [3]]
# data = np.array(data)
# scaled_data = scale_to_range(data, -1, 1)
# unscaled_data = unscale_from_range(scaled_data, data, -1, 1)
# print(data)
# print(scaled_data)
# print(unscaled_data)